...
TACTIC_RULES = {
    HEIMA: "主板非 ST；连续三天涨停（第三天可炸板未回封）；之后 13 个交易日内缩量回踩，不破第三日收盘、不破十日线。",
    N_FAN: "主板非 ST；放量涨停；之后 8 个交易日内缩量回踩，不破涨停阳线开盘价。",
    NIU_SAN: "非 ST；跳空高开大阳线或涨停；之后缩量回踩不破该阳线开盘价，且不跌破 39 日均线。",
}
