...
export const PATTERN_NAMES: Record<string, string> = {
  ...
  'Morning Star': '启明星',
  'Evening Star': '黄昏星',
  'Doji Morning Star': '十字启明星',
  'Doji Evening Star': '十字黄昏星',
  ...
  'Tower Top': '塔形顶部',
  'Rounded Top': '圆形顶部',
  'Frying Pan Bottom': '平底锅底部',
  'Three Mountains': '三山形态',
  'Advance Block': '前进受阻',
  Stalled: '停顿形态',
  ...
  'Bullish Springboard': '破低反涨',
  'Bearish Springboard': '破高反跌',
  'Golden Cross': '黄金交叉',
  'Death Cross': '死亡交叉',
}
